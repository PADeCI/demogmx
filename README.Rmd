...
```{r eval=FALSE, echo=F}
#' Check 
#' https://github.com/DARTH-git/darthpack/blob/master/README.Rmd
```
...
El contenido de este repositorio debe utilizarse bajo las condiciones de la [licencia MIT](https://en.wikipedia.org/wiki/MIT_License).
...
This repository's content must be used under the terms and conditions of the [MIT License](https://en.wikipedia.org/wiki/MIT_License)
